...
// 3infotech.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy3infotechApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMy3infotechApp

CMy3infotechApp::CMy3infotechApp()
{
...
// Единственный объект CMy3infotechApp

CMy3infotechApp theApp;


// Инициализация CMy3infotechApp

BOOL CMy3infotechApp::InitInstance()
{
